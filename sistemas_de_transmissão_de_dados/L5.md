...
*Figura 12: Espectro de magnitude do sinal recuperado pelo filtro de envoltória modulado com portadora com deslocamento de fase*
...
*Figura 13: Espectro de magnitude do sinal recuperado pelo filtro de envoltória modulado com portadora com deslocamento de fase $$\phi = $$ *




*Figura 14: Espectro de magnitude do sinal recuperado pelo filtro de envoltória modulado com portadora com deslocamento de fase $$\phi = $$ *




*Figura 15: Espectro de magnitude do sinal recuperado pelo filtro de envoltória modulado com portadora com deslocamento de fase $$\phi = $$ *




*Figura 16: Espectro de magnitude do sinal recuperado pelo filtro de envoltória modulado com portadora com deslocamento de fase $$\phi = $$ *




*Figura 17: Espectro de magnitude do sinal recuperado pelo filtro de envoltória modulado com portadora com deslocamento de fase $$\phi = $$ *




*Figura 18: Espectro de magnitude do sinal recuperado pelo filtro de envoltória modulado com portadora com deslocamento de fase $$\phi = $$ *




*Figura 19: Espectro de magnitude do sinal recuperado pelo filtro de envoltória modulado com portadora com deslocamento de fase $$\phi = $$ *


para os valores de fase $$\phi = []$$, podemos perceber que a distorção foi mínima, porém para os restantes dos valores do vetor $$\phi$$
...
*Figura X: Espectro de magnitude do sinal de mensagem com largura de banda de 100Hz enviado e Espectro de magnitude do sinal modulado por lei quadrática*
...
*Figura X: Espectro de magnitude do sinal de mensagem com largura de banda de 100Hz enviado e Espectro de magnitude do sinal demodulado*
...
*Figura X: Distorção de amplitude no sinal demodulado devido ao erro de fase \phi*
...
*Figura X: Distorção de amplitude no sinal demodulado devido ao erro de frequência $\gamma = 200$*


![image](https://github.com/user-attachments/assets/fbc814db-87d5-45ce-9718-9052e4c2508c)

*Figura X: Distorção de amplitude no sinal demodulado devido ao erro de frequência $\gamma = 500$*
