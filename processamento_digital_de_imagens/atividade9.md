...
### Cepstrum complexo
O cepstrum complexo é um domínio aonde levamos nossa imagem, a viagem até esse domínio tem como ponto de passagem o domínio da frequência ja conhecido que somos levados pela 
transformada de fourier, e para chegarmos ao cepstrum complexo basta aplicar a operação de logaritmo.
